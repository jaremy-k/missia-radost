...
const dollCards = [
  ...
  {
    title: "Гусь-обнимусь",
    image: "/catalog/dolls/goose.png",
    price: "от 2 000 ₽",
    features: ["Рост: 2,60 м", "Музыкальное сопровождение", "Весёлые танцы"],
    description:
      "Гусь-обнимусь с красным бантом — яркий и необычный герой. Он добавит празднику юмора, объятий и море позитива.",
  },
  {
    title: "Малыши",
    image: "/catalog/dolls/babies.png",
    price: "от 4 000 ₽",
    features: [
      "2 персонажа: мальчик и девочка",
      "Музыкальное сопровождение",
      "Весёлые танцы",
    ],
    description:
      "Милые малыши в розовом и голубом — идеальный выбор для детского праздника. Двойное внимание и двойные эмоции для именинника.",
  },
  {
    title: "Крокодил Гена",
    image: "/catalog/dolls/gena-crocodile.png",
    price: "от 2 000 ₽",
    features: ["Рост: 2,60 м", "Музыкальное сопровождение", "Весёлые танцы"],
    description:
      "Легендарный Крокодил Гена в красном пиджаке — добрый и музыкальный герой, который знаком и детям, и взрослым.",
  },
  {
    title: "Розовый мишка",
    image: "/catalog/dolls/pink-bear.png",
    price: "от 2 000 ₽",
    features: ["Рост: 2,60 м", "Музыкальное сопровождение", "Весёлые танцы"],
    description:
